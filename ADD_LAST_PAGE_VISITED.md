# Add Last Page Visited Tracking

Run these 2 SQL migrations in Supabase Dashboard SQL Editor:
...
Done! The frontend code is already updated to track and display this data.
