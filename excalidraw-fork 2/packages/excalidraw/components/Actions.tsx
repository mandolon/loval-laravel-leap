    ...
    <>
      {getToolbarTools(app).map(
        ({ value, icon, key, numericKey, fillable }, index) => {
          ...
          // Special handling for Line tool: show a dropdown menu for stroke width
          if (value === "line") {
            return (
              <DropdownMenu open={isLineMenuOpen} key={value}>
                <DropdownMenu.Trigger
                  className={clsx("Shape", {
                    fillable,
                    "ToolIcon": true,
                    "ToolIcon--selected": activeTool.type === value,
                  })}
                  onToggle={() => {
                ...
                <DropdownMenu.Content
                  onClickOutside={() => setIsLineMenuOpen(false)}
                  onSelect={() => setIsLineMenuOpen(false)}
                >
                  <DropdownMenu.Item
                    onSelect={() =>
                      setAppState({
                    ...
                    selected={
                      app.state.currentItemStrokeWidth === STROKE_WIDTH.thin
                    }
                  >
                    {t("labels.thin")}
                  </DropdownMenu.Item>
                  <DropdownMenu.Item
                    ...
                    selected={
                      app.state.currentItemStrokeWidth === STROKE_WIDTH.bold
                    }
                  >
                    {t("labels.bold")}
                  </DropdownMenu.Item>
