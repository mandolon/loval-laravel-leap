...
export class IfcDimensionLine {
  ...
  private formatMetersToFeetInches(meters: number): string {
  ...
  private getTextContent() {
    const lengthInMeters = this.length * IfcDimensionLine.scale;
    // Use feet and inches format
    return this.formatMetersToFeetInches(lengthInMeters);
  }
