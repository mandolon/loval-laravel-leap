...
export type PageType = 'home' | 'projects' | 'taskboard' | 'completed' | 'ai' | 'detail-library' | 'building-codes' | 'knowledge-base'

export type SidebarTab = 'home' | 'workspace' | 'taskboard' | 'ai' | 'detail-library' | 'building-codes' | 'knowledge-base'
