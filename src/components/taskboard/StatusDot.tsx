...
export function StatusDot({ status, onClick, className }: StatusDotProps) {
  ...
  const getStatusStyles = () => {
    switch (status) {
      case "task_redline":
        return "border-red-700 border-dashed bg-transparent hover:bg-red-50";
      case "progress_update":
        return "border-blue-800 border-dashed bg-transparent hover:bg-blue-50";
      case "done_completed":
        return "border-green-700 border-solid bg-gradient-to-br from-green-700 via-green-600 to-green-500";
      default:
        return "";
    }
  };
