    ...
    return (
      <div className="flex flex-col items-start justify-start px-3 pb-3 space-y-2">
        <NavLink
          ...
          className={({ isActive }) => `
            px-2.5 py-1 ${T.radius} w-full text-left transition-colors
            ${isActive && !location.search ? 'bg-slate-100 dark:bg-[#141C28] text-[#00639b] dark:text-blue-300 font-medium' : 'text-slate-500 dark:text-neutral-400 hover:bg-slate-50 dark:hover:bg-[#141C28] hover:text-slate-700 dark:hover:text-blue-300'} ${T.focus}
          `}
        >
          <span>All Tasks</span>
        </NavLink>
        <NavLink
          ...
          className={({ isActive }) => `
            px-2.5 py-1 ${T.radius} w-full text-left transition-colors
            ${location.search.includes('my-tasks') ? 'bg-slate-100 dark:bg-[#141C28] text-[#00639b] dark:text-blue-300 font-medium' : 'text-slate-500 dark:text-neutral-400 hover:bg-slate-50 dark:hover:bg-[#141C28] hover:text-slate-700 dark:hover:text-blue-300'} ${T.focus}
          `}
        >
          <span>My Tasks</span>
        </NavLink>
        <NavLink
          ...
          className={({ isActive }) => `
            px-2.5 py-1 ${T.radius} w-full text-left transition-colors
            ${location.search.includes('completed') ? 'bg-slate-100 dark:bg-[#141C28] text-[#00639b] dark:text-blue-300 font-medium' : 'text-slate-500 dark:text-neutral-400 hover:bg-slate-50 dark:hover:bg-[#141C28] hover:text-slate-700 dark:hover:text-blue-300'} ${T.focus}
          `}
        >
          <span>Completed</span>
        </NavLink>
