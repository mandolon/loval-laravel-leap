...
import { FileIcon, Star, CheckCircle2 } from 'lucide-react';
import { useWorkspaceFiles } from '@/lib/api/hooks/useWorkspaceFiles';
          ...
          <div className="flex flex-col items-center justify-center h-full py-16">
            ...
            <div className="text-center">
              ...
              <p className="text-sm" style={{ color: THEME.textSecondary }}>
                Upload files from the workspace chat to see them here
              </p>
            </div>
          </div>
        ) : viewMode === 'grid' ? (
