...
export const ActivityItem: React.FC<ActivityItemProps> = ({
  ...
  return (
    <div className={`flex gap-3 items-center py-3 md:py-2.5 px-3 md:px-4 hover:bg-neutral-50 active:bg-neutral-100 transition-colors touch-manipulation cursor-pointer ${borderClasses}`}>
