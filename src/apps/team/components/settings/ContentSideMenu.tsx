...
import { User, LayoutGrid, Users, Repeat, Trash2, LogOut, Settings, Download, Sparkles } from 'lucide-react';
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ai-assistant', icon: Sparkles, label: 'AI Assistant', route: 'ai-assistant' },
