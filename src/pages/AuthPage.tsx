  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <form onSubmit={view === 'forgot-password' ? handleForgotPassword : view === 'login' ? handleSignIn : handleSignUp} className="w-full max-w-[440px]">
          {/* Header */}
          <div className="flex flex-col items-center text-center select-none">
            {view === 'login' ? (
              ...
              <>
                <h1 className="text-2xl font-semibold text-slate-800">Reset your password</h1>
                <p className="mt-2 text-sm text-slate-500">
            ...
            <>
              ...
              <div className="mt-8">
                <button
                  ...
                  disabled={loading}
                  className="h-10 w-full rounded-lg border border-slate-200 bg-transparent transition text-slate-700 text-sm font-medium relative inline-flex items-center justify-center hover:border-[#d2e3fc] hover:bg-[#f0f5fe] active:border-[#00639b] disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
                >
            ...
            <div className="mt-8">
              {!resetEmailSent ? (
                <>
                  ...
                  <button
                    ...
                    className="mt-5 h-9 w-full rounded-lg font-semibold inline-flex items-center justify-center gap-2 transition disabled:opacity-60 disabled:cursor-not-allowed bg-[#00639b] text-white hover:bg-[#005480]"
                  >
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 text-green-700 text-sm p-4">
                  <p className="font-medium">Check your email</p>
                  <p className="mt-1">We've sent a password reset link to <strong>{email}</strong></p>
                  <p className="mt-2 text-xs">Didn't receive it? Check your spam folder or try again.</p>
                </div>
              )}
              ...
              <div className="mt-4 text-center">
                <button
                  ...
                  className="text-sm text-[#3a78bd] hover:text-[#2c5e96] hover:underline"
                >
                  ← Back to Login
                </button>
              </div>
            ...
            <>
              <div className="mt-4 space-y-3">
                {view === 'signup' && (
                  <div className="flex gap-3">
                    <input
                      ...
                      disabled={loading}
                      className="w-1/2 h-8 rounded-lg border bg-white text-[13px] text-slate-700 placeholder:text-slate-400 placeholder:text-[13px] px-3 outline-none transition border-slate-200 hover:border-slate-300 focus:border-[#00639b] focus:ring-1 focus:ring-[#9ecafc] disabled:bg-slate-100 disabled:cursor-not-allowed [&:-webkit-autofill]:shadow-[inset_0_0_0px_1000px_white] [&:-webkit-autofill]:[-webkit-text-fill-color:rgb(51_65_85)]"
                    />
                    <input
                      type="text"
                      value={lastName}
                ...
                <input
                  ...
                  placeholder="Work email"
                  disabled={loading}
                  className="w-full h-8 rounded-lg border bg-white text-[13px] text-slate-700 placeholder:text-slate-400 placeholder:text-[13px] px-3 outline-none transition border-slate-200 hover:border-slate-300 focus:border-[#00639b] focus:ring-1 focus:ring-[#9ecafc] disabled:bg-slate-100 disabled:cursor-not-allowed [&:-webkit-autofill]:shadow-[inset_0_0_0px_1000px_white] [&:-webkit-autofill]:[-webkit-text-fill-color:rgb(51_65_85)]"
                />
                ...
                <div className="relative">
                  <input
                    ...
                    disabled={loading}
                    className="w-full h-8 rounded-lg border bg-white text-[13px] text-slate-700 placeholder:text-slate-400 placeholder:text-[13px] pr-10 px-3 outline-none transition border-slate-200 hover:border-slate-300 focus:border-[#00639b] focus:ring-1 focus:ring-[#9ecafc] disabled:bg-slate-100 disabled:cursor-not-allowed [&:-webkit-autofill]:shadow-[inset_0_0_0px_1000px_white] [&:-webkit-autofill]:[-webkit-text-fill-color:rgb(51_65_85)]"
                  />
                  <button
                    type="button"
