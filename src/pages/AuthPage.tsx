      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <form onSubmit={view === 'login' ? handleSignIn : handleSignUp} className="w-full max-w-[440px]">
          ...
          <div className="mt-8">
            <button
              type="button"
              className="h-10 w-full rounded-lg border border-slate-200 bg-transparent transition text-slate-700 text-sm font-medium inline-flex items-center justify-center gap-2 hover:border-[#d2e3fc] hover:bg-[#f0f5fe] active:border-[#00639b]"
              disabled
            >
