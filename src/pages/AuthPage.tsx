            ...
            {view === 'signup' && (
              <div className="flex gap-3">
                <input
                  ...
                  disabled={loading}
                  className="w-1/2 h-8 rounded-lg border bg-white text-[13px] text-slate-700 placeholder:text-slate-400 placeholder:text-[13px] px-3 outline-none transition border-slate-200 hover:border-slate-300 focus:border-[#00639b] focus:ring-1 focus:ring-[#9ecafc] disabled:bg-slate-100 disabled:cursor-not-allowed [&:-webkit-autofill]:bg-white [&:-webkit-autofill]:text-slate-700 [&:-webkit-autofill]:shadow-[inset_0_0_0px_1000px_white]"
                />
                <input
                  type="text"
                  value={lastName}
