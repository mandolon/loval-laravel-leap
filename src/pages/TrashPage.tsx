  ...
  const loadDeletedProjects = async () => {
    try {
      ...
      const transformedProjects = data.map((row) => ({
        ...
        status: row.status as 'pending' | 'active' | 'completed' | 'archived',
        phase: row.phase as 'Pre-Design' | 'Design' | 'Permit' | 'Build',
        ...
        primaryClient: {
          ...
          address: row.primary_client_address as any,
        },
        secondaryClient: row.secondary_client_first_name ? {
          ...
          address: row.secondary_client_address as any,
        } : undefined,
        assessorParcelInfo: (row.assessor_parcel_info as any) || {},
